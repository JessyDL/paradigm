...
std::unordered_map<uint64_t, serialization::polymorphic_data*>& serialization::accessor::polymorphic_data()
{
	...
	{
		m_PolymorphicData = std::make_unique<std::unordered_map<uint64_t, serialization::polymorphic_data*>>();
	}
