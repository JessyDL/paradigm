...
#define INTERNAL_BENCHMARK_2(DESCRIPTION, MOCKUP)                                                                      \
	INTERNAL_CREATE_BENCHMARK_PARAMS(INTERNAL_UNIQUE_NAME(BENCHMARK_TEST_FUNC), DESCRIPTION, typename MOCKUP, false)

#define INTERNAL_BENCHMARK_3(DESCRIPTION, MOCKUP, REUSE)                                                               \
	INTERNAL_CREATE_BENCHMARK_PARAMS(INTERNAL_UNIQUE_NAME(BENCHMARK_TEST_FUNC), DESCRIPTION, typename MOCKUP, REUSE)
