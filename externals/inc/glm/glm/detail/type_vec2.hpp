...
namespace glm
{
	...
	struct tvec2
	{
		...
		const static tvec2<T, P>  Zero, One, Up, Down, Left, Right, Infinity;
		// -- Data --
...
#		endif// GLM_HAS_UNRESTRICTED_UNIONS && (GLM_SWIZZLE == GLM_SWIZZLE_ENABLED)
	...
	template<typename T, precision P>
	const glm::tvec2<T, P> glm::tvec2<T, P>::Zero = glm::tvec2<T, P>(0, 0);
	template<typename T, precision P>
	const glm::tvec2<T, P> glm::tvec2<T, P>::One = glm::tvec2<T, P>(1, 1);
	template<typename T, precision P>
	const glm::tvec2<T, P> glm::tvec2<T, P>::Up = glm::tvec2<T, P>(0, 1);
	template<typename T, precision P>
	const glm::tvec2<T, P> glm::tvec2<T, P>::Down = glm::tvec2<T, P>(0, -1);
	template<typename T, precision P>
	const glm::tvec2<T, P> glm::tvec2<T, P>::Left = glm::tvec2<T, P>(1, 0);
	template<typename T, precision P>
	const glm::tvec2<T, P> glm::tvec2<T, P>::Right = glm::tvec2<T, P>(-1, 0);
	template<typename T, precision P>
	const glm::tvec2<T, P> glm::tvec2<T, P>::Infinity = glm::tvec2<T, P>(std::numeric_limits<float>::infinity());
