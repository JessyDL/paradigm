...
namespace glm
{
	...
	struct tvec3
	{
		...
		const static tvec3<T, P>  Zero; // x = 0, y = 0, z = 0    
		const static tvec3<T, P>  One; // x = 0, y = 0, z = 0
		const static tvec3<T, P>  Up; // x = 0, y = 0, z = 0
		const static tvec3<T, P>  Down; // x = 0, y = 0, z = 0
		const static tvec3<T, P>  Left; // x = 0, y = 0, z = 0
		const static tvec3<T, P>  Right; // x = 0, y = 0, z = 0
		const static tvec3<T, P>  Forward; // x = 0, y = 0, z = 0
		const static tvec3<T, P>  Back; // x = 0, y = 0, z = 0
		const static tvec3<T, P>  Infinity; // x = 0, y = 0, z = 0
...
#		endif// GLM_HAS_UNRESTRICTED_UNIONS && (GLM_SWIZZLE == GLM_SWIZZLE_ENABLED)
	...
	template<typename T, precision P>
	// x = 0, y = 0, z = 0
	const glm::tvec3<T, P> glm::tvec3<T, P>::Zero = glm::tvec3<T, P>(0,0,0);
	template<typename T, precision P>
	// x = 1, y = 1, z = 1
	const glm::tvec3<T, P> glm::tvec3<T, P>::One = glm::tvec3<T, P>(1, 1, 1);
	template<typename T, precision P>
	// x = 0, y = 1, z = 0
	const glm::tvec3<T, P> glm::tvec3<T, P>::Up = glm::tvec3<T, P>(0, 1, 0);
	template<typename T, precision P>
	// x = 0, y = -1, z = 0
	const glm::tvec3<T, P> glm::tvec3<T, P>::Down = glm::tvec3<T, P>(0, -1, 0);
	template<typename T, precision P>
	// x = 0, y = 0, z = 1
	const glm::tvec3<T, P> glm::tvec3<T, P>::Forward = glm::tvec3<T, P>(0, 0, 1);
	template<typename T, precision P>
	// x = 0, y = 0, z = -1
	const glm::tvec3<T, P> glm::tvec3<T, P>::Back = glm::tvec3<T, P>(0, 0, -1);
	template<typename T, precision P>
	// x = -1, y = 0, z = 0
	const glm::tvec3<T, P> glm::tvec3<T, P>::Left = glm::tvec3<T, P>(1, 0, 0);
	template<typename T, precision P>
	// x = 1, y = 0, z = 0
	const glm::tvec3<T, P> glm::tvec3<T, P>::Right = glm::tvec3<T, P>(-1, 0, 0);
	template<typename T, precision P>
	// x = INF, y = INF, z = INF
	const glm::tvec3<T, P> glm::tvec3<T, P>::Infinity = glm::tvec3<T, P>(std::numeric_limits<float>::infinity());
}//namespace glm
