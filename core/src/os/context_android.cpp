...
core::os::context::context(android_app* application) : m_Application(application)
{
	...
	m_SensorEventQueue =
	  ASensorManager_createEventQueue(m_SensorManager, m_Application->looper, LOOPER_ID_USER, nullptr, nullptr);
...
auto core::os::context::application() noexcept -> android_app& { return *m_Application; }
