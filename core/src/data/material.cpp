...
// blendstate
bool material_t::blendstate::enabled() const {
	return m_Enabled.value;
}
uint32_t material_t::blendstate::binding() const {
	return m_Binding.value;
}
core::gfx::blend_factor material_t::blendstate::color_blend_src() const {
	return m_ColorBlendFactorSrc.value;
}
core::gfx::blend_factor material_t::blendstate::color_blend_dst() const {
	return m_ColorBlendFactorDst.value;
}
core::gfx::blend_op material_t::blendstate::color_blend_op() const {
	return m_ColorBlendOp.value;
}
core::gfx::blend_factor material_t::blendstate::alpha_blend_src() const {
	return m_AlphaBlendFactorSrc.value;
}
core::gfx::blend_factor material_t::blendstate::alpha_blend_dst() const {
	return m_AlphaBlendFactorDst.value;
}
core::gfx::blend_op material_t::blendstate::alpha_blend_op() const {
	return m_AlphaBlendOp.value;
}
core::gfx::component_bits material_t::blendstate::color_components() const {
	return m_ColorComponents.value;
}

void material_t::blendstate::enabled(bool value) {
	m_Enabled.value = value;
}
void material_t::blendstate::binding(uint32_t value) {
	m_Binding.value = value;
}
void material_t::blendstate::color_blend_src(core::gfx::blend_factor value) {
	m_ColorBlendFactorSrc.value = value;
}
void material_t::blendstate::color_blend_dst(core::gfx::blend_factor value) {
	m_ColorBlendFactorDst.value = value;
}
void material_t::blendstate::color_blend_op(core::gfx::blend_op value) {
	m_ColorBlendOp.value = value;
}
void material_t::blendstate::alpha_blend_src(core::gfx::blend_factor value) {
	m_AlphaBlendFactorSrc.value = value;
}
void material_t::blendstate::alpha_blend_dst(core::gfx::blend_factor value) {
	m_AlphaBlendFactorDst.value = value;
}
void material_t::blendstate::alpha_blend_op(core::gfx::blend_op value) {
	m_AlphaBlendOp.value = value;
}
void material_t::blendstate::color_components(core::gfx::component_bits value) {
	m_ColorComponents.value = value;
}

// attribute
uint32_t material_t::attribute::location() const noexcept {
	return m_Location.value;
}
void material_t::attribute::location(uint32_t value) noexcept {
	m_Location.value = value;
}

const psl::UID& material_t::attribute::buffer() const noexcept {
	return m_Buffer;
}
void material_t::attribute::buffer(psl::UID value) noexcept {
	m_Buffer = std::move(value);
}

psl::string_view material_t::attribute::tag() const noexcept {
	return m_Tag;
}
void material_t::attribute::tag(psl::string8_t value) noexcept {
...
void material_t::attribute::input_rate(core::gfx::vertex_input_rate value) noexcept {
	m_InputRate = value;
}

// binding
uint32_t material_t::binding::binding_slot() const {
	return m_Binding.value;
}
core::gfx::binding_type material_t::binding::descriptor() const {
	return m_Description.value;
}
const UID& material_t::binding::texture() const {
	return m_UID;
}
const UID& material_t::binding::sampler() const {
	return m_SamplerUID;
}
const UID& material_t::binding::buffer() const {
	return m_Buffer;
}

void material_t::binding::binding_slot(uint32_t value) {
	m_Binding.value = value;
}
void material_t::binding::descriptor(core::gfx::binding_type value) {
...
// stage
core::gfx::shader_stage material_t::stage::shader_stage() const noexcept {
	return m_Stage.value;
}
const UID& material_t::stage::shader() const noexcept {
...
void material_t::stage::bindings(psl::array<binding> value) noexcept {
	m_Bindings.value = std::move(value);
}

const psl::array<material_t::attribute>& material_t::stage::attributes() const noexcept {
...
void material_t::stage::erase(const binding& value) {
	...
	if(it != std::end(m_Bindings.value))
		m_Bindings.value.erase(it);
}
// material
const psl::array<material_t::stage>& material_t::stages() const {
	return m_Stage.value;
}
const psl::array<material_t::blendstate>& material_t::blend_states() const {
	return m_BlendStates.value;
}
const psl::array<psl::string8_t>& material_t::defines() const {
	return m_Defines.value;
}
core::gfx::cullmode material_t::cull_mode() const {
	return m_Culling.value;
}
core::gfx::compare_op material_t::depth_compare_op() const {
	return m_DepthCompareOp.value;
}
uint32_t material_t::render_layer() const {
	return m_RenderLayer.value;
}
bool material_t::depth_test() const {
	return m_DepthTest.value;
}
bool material_t::depth_write() const {
	return m_DepthWrite.value;
}
...
void material_t::blend_states(const psl::array<blendstate>& values) {
	m_BlendStates.value = values;
}
void material_t::defines(const psl::array<psl::string8_t>& values) {
	m_Defines.value = values;
}
void material_t::cull_mode(core::gfx::cullmode value) {
	m_Culling.value = value;
}
void material_t::depth_compare_op(core::gfx::compare_op value) {
	m_DepthCompareOp.value = value;
}
void material_t::render_layer(uint32_t value) {
	m_RenderLayer.value = value;
}
void material_t::depth_test(bool value) {
	m_DepthTest.value = value;
}
void material_t::depth_write(bool value) {
	m_DepthWrite.value = value;
}
void material_t::wireframe(bool value) {
	m_Wireframe.value = value;
}
...
void material_t::define(psl::string8::view value) {
	...
	if(it == std::end(m_Defines.value))
		m_Defines.value.emplace_back(value);
}
