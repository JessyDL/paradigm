...
{
	std::transform(std::begin(materials), std::end(materials), std::back_inserter(m_Data.value),
...
{
	m_Data.value.erase(std::remove_if(std::begin(m_Data.value), std::end(m_Data.value),
