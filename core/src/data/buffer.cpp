...
core::gfx::memory_usage buffer_t::usage() const {
	return m_Usage.value;
}
core::gfx::memory_property buffer_t::memoryPropertyFlags() const {
	return m_MemoryPropertyFlags.value;
}
const memory::region& buffer_t::region() const {
	return m_Region;
}
const std::vector<memory::segment>& buffer_t::segments() const {
	return m_Segments;
};

bool buffer_t::transient() const noexcept {
	return m_Transient.value;
}
void buffer_t::transient(bool value) noexcept {
	m_Transient.value = value;
}
core::gfx::memory_write_frequency buffer_t::write_frequency() const noexcept {
	return m_WriteFrequency.value;
}
void buffer_t::write_frequency(core::gfx::memory_write_frequency value) noexcept {
	m_WriteFrequency.value = value;
}
