...
grid::grid(state& state,
		   ...
		   resource::handle<buffer> vertexBuffer,
		   resource::handle<buffer> indexBuffer,
		   resource::handle<pipeline_cache> pipeline_cache,
		   resource::handle<shader_buffer_binding> instanceMaterialBuffer,
		   resource::handle<buffer> instanceVertexBuffer,
		   psl::vec3 scale,
		   psl::vec3 offset) :
	m_Target(target),
	m_Scale(scale), m_Offset(offset)
{
	...
	utility::geometry::copy_channel(
	  boxData, core::data::geometry::constants::POSITION, core::data::geometry::constants::COLOR);
	...
	utility::geometry::copy_channel(
	  boxData2, core::data::geometry::constants::POSITION, core::data::geometry::constants::COLOR);
