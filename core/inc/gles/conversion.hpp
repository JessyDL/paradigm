...
inline core::gfx::format_t to_format(GLint internalFormat, GLint format, GLint type) noexcept
{
	...
	// case GL_UNSIGNED_BYTE_3_3_2: psl_assert(format == GL_RGB || format == GL_RGB_INTEGER, "format failed check");
	// return core::gfx::format_t::undefined; case GL_UNSIGNED_BYTE_2_3_3_REV: 	psl_assert(format == GL_BGR ||
	// format == GL_BGR_INTEGER, "format failed check");
	//	return core::gfx::format_t::undefined;
	...
	//	psl_assert(format == GL_RGB || format == GL_BGRA || format == GL_RGB_INTEGER || format == GL_BGRA_INTEGER,
	//"format failed check"); 	return core::gfx::format_t::a1r5g5b5_unorm_pack16;
	// case GL_UNSIGNED_INT_8_8_8_8:
	//	psl_assert(format == GL_RGB || format == GL_BGRA || format == GL_RGB_INTEGER || format == GL_BGRA_INTEGER,
	//"format failed check"); 	return (format == GL_RGB_INTEGER || format == GL_BGRA_INTEGER) ?
	// core::gfx::format_t::r8g8b8a8_uint 																   :
	// core::gfx::format_t::r8g8b8a8_unorm;
	// case GL_UNSIGNED_INT_8_8_8_8_REV:
	//	psl_assert(format == GL_RGB || format == GL_BGRA || format == GL_RGB_INTEGER || format == GL_BGRA_INTEGER,
	//"format failed check"); 	return (format == GL_RGB_INTEGER || format == GL_BGRA_INTEGER) ?
	// core::gfx::format_t::a8b8g8r8_uint_pack32 																   :
	// core::gfx::format_t::a8b8g8r8_unorm_pack32;
	// case GL_UNSIGNED_INT_10_10_10_2:
	//	psl_assert(format == GL_RGB || format == GL_BGRA || format == GL_RGB_INTEGER || format == GL_BGRA_INTEGER,
	//"format failed check"); 	return (format == GL_RGB_INTEGER || format == GL_BGRA_INTEGER) 			   ?
	// core::gfx::format_t::a2r10g10b10_uint_pack32 			   : core::gfx::format_t::a2r10g10b10_unorm_pack32;
