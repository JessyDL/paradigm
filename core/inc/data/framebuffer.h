...
namespace core::data
{
	...
	class framebuffer final
	{
	  ...
	  public:
		...
		/// core::gfx::texture. You should take caution when calling methods that manipulate the contained resources for
		/// this reason.
		  ...
		  public:
			...
			class description final
			{
			  ...
			  private:
				...
				psl::serialization::property<"FORMAT", core::gfx::format> m_Format;
			};
			...
			/// core::data::framebuffer::attachment::description. \param[in] shared value indicating if this render
			/// attachment is shared within this framebuffer (see core::data::framebuffer::attachment::shared() for more
			/// info).
			...
			/// the core::data::framebuffer::attachment::description instance. \returns a core::gfx::attachment based on
			...
			/// core::ivk::framebuffer for the application of this flag. \returns true if this attachment is duplicated
			/// (true) or not (false).
			bool shared() const;
		...
		/// core::ivk::framebuffer just yet with this after calling the constructor. \param[in] uid the resouce system
