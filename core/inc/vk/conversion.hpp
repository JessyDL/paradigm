...
inline memory_usage to_memory_usage(vk::BufferUsageFlags flags) noexcept {
	...
	res += (flags & vk::BufferUsageFlagBits::eConditionalRenderingEXT)
			 ...
			 : 0;
	res += (flags & vk::BufferUsageFlagBits::eTransferSrc) ? static_cast<gfx_type>(memory_usage::transfer_source) : 0;
	res +=
	  (flags & vk::BufferUsageFlagBits::eTransferDst) ? static_cast<gfx_type>(memory_usage::transfer_destination) : 0;
	...
	res += (flags & vk::BufferUsageFlagBits::eUniformBuffer) ? static_cast<gfx_type>(memory_usage::uniform_buffer) : 0;

	res += (flags & vk::BufferUsageFlagBits::eStorageBuffer) ? static_cast<gfx_type>(memory_usage::storage_buffer) : 0;
...
inline memory_property to_memory_property(vk::MemoryPropertyFlags flags) noexcept {
	...
	res += (flags & vk::MemoryPropertyFlagBits::eHostCached) ? static_cast<gfx_type>(memory_property::host_cached) : 0;
	res +=
	...
	res +=
	  (flags & vk::MemoryPropertyFlagBits::eProtected) ? static_cast<gfx_type>(memory_property::protected_memory) : 0;

	res +=
	  (flags & vk::MemoryPropertyFlagBits::eHostCoherent) ? static_cast<gfx_type>(memory_property::host_coherent) : 0;
...
inline vk::ImageLayout to_vk(core::gfx::image::layout layout) noexcept {
	...
	static_assert(static_cast<vk_type>(vk_etype::ePreinitialized) == static_cast<gfx_type>(gfx_etype::preinitialized));
	...
	static_assert(static_cast<vk_type>(vk_etype::ePresentSrcKHR) == static_cast<gfx_type>(gfx_etype::present_src_khr));
