...
namespace core::ivk
{
	...
	class pipeline
	{
	  public:
		...
		/// of the correct type, otherwise it returns false. \param[in] bindingLocation the binding location to update.
		...
		/// descriptor binding point to be successful. \param[in] bindingLocation the binding location to update.
