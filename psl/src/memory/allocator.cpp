...
bool allocator_base::commit(const range_t& range) {
...
std::vector<range_t> allocator_base::committed() {
	return get_committed();
}
std::vector<range_t> allocator_base::available() {
	return get_available();
}

memory::range_t allocator_base::get_range() const {
