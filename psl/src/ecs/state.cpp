...
{	 // wrap pushes to back of container as output iterator
  ...
  public:
	...
	_NODISCARD special_insert_iterator& operator*() noexcept /* strengthened */ { return *this; }

	special_insert_iterator& operator++() noexcept /* strengthened */ { return *this; }

	special_insert_iterator operator++(int) noexcept /* strengthened */ { return *this; }
