...
#pragma region arithmetic
		...
		template <typename rhs_t>
		constexpr force_inline auto operator>>(const rhs_t& rhs) const noexcept(
		  concepts::HasBitRightShiftNothrow<value_type, rhs_t>) requires(concepts::HasBitRightShift<value_type, rhs_t>)
		{
			return value >> rhs;
		}
#pragma endregion
...
#pragma region comparison
		...
		*/
		...
		template <typename rhs_t>
		constexpr force_inline auto operator<=(const rhs_t& rhs) noexcept(
		  concepts::HasLessEqualThanNothrow<value_type, rhs_t>) requires(concepts::HasLessEqualThan<value_type, rhs_t>)
		{
			return value <= rhs;
		}
		template <typename rhs_t>
