...
auto t0_sparse = litmus::suite<"psl::sparse_array">() = []() {
	...
	section<"chunk_bound_ops">() = []() {
		...
		require(array[4095]) == 10;
		require(array[4096]) == 20;
		require(array[4097]) == 30;
		require(array[8191]) == 40;
		require(array[8192]) == 50;
		array.erase(indices.begin(), indices.begin() + 2);
		require(array.size()) == 3;
		require(array.contains(4095)) == false;
		require(array.contains(4096)) == false;
		require(array[4097]) == 30;
		require(array[8191]) == 40;
		require(array[8192]) == 50;
